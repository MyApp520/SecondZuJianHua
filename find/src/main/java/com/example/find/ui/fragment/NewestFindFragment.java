 ...
 */
@Route(path = FindModuleArouterPath.NEWEST_FIND_FRAGMENT)
public class NewestFindFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_newest_find, container, false);
    ...
    public void onResume() {
        super.onResume();
        Log.e(TAG, "NewestFindFragment onResume: userBean = " + userBean);
    }
